                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @csrf
                                        ...
                                        <div class="form-group">
                                        <input id="usu_pass" type="password" class="form-control form-control-user" name="usu_pass" required autocomplete="current-password">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <a class="small" onclick="window.location.href='/register'">Crear cuenta!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
